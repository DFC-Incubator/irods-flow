...
/**
 * Starts the Spring Context and will initialize the Spring Integration message
 * flow.
 *
 * @author Gary Russell.
 * @since 4.0
...
public final class SamplePubConfirmsReturns {
	...
	public static final org.slf4j.Logger log = LoggerFactory.getLogger(SamplePubConfirmsReturns.class);
	...
	public static void main(final String... args) {
		...
		final AbstractApplicationContext context = new ClassPathXmlApplicationContext(
				"classpath:/spring-integration-confirms-context.xml");
